          ...
          <Card className="h-full">
            ...
            <CardContent>
              ...
              {result && !loading && result.error && (
                <div className="h-48 flex flex-col items-center justify-center text-red-500 border border-red-500/20 bg-red-500/5 rounded-lg p-4 overflow-y-auto">
                  <AlertTriangle className="h-8 w-8 mb-2 shrink-0" />
                  <p className="text-sm text-center break-all whitespace-pre-wrap">Error analyzing text: {result.error}</p>
                </div>
              )}
